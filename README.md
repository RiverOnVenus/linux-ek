...
You should compile it yourself and choose the optimization option that suits you. (**NOTE**: The package on the [releases](https://github.com/RiverOnVenus/linux-ck-tt/releases) page is a very small kernel ([module list](https://github.com/RiverOnVenus/dotfiles/blob/master/home/.config/modprobed.db)) compiled from the configuration generated by modprobed-db on my intel device, and may only be applicable to intel devices, not universal.)
